...
public class AlarmReminderProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITY, AlarmReminderContract.PATH_REMINDER, REMINDER);

        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITY, AlarmReminderContract.PATH_REMINDER + "/#", REMINDER_ID);
